...
// Data Initialization using code

var letters=[];
var letter={};

for(i=0;i<26;i++){
 var chr = String.fromCharCode(65 + i);  /*ASCII for uppercase A-Z (65-90)*/
letter.name= chr ;
letter.id= i+1;
letter.fid=i+1;
letters.push({name:letter.name,id:letter.id,fid:letter.fid})
// console.log(letters)
}

for(i=0;i<26;i++){
var chr = String.fromCharCode(97 + i);    /*ASCII for lowercase a-z (97-122)*/
letter.name= chr ;
letter.id=26+i+1;
letter.fid=26+i+1;
letters.push({name:letter.name,id:letter.id,fid:letter.fid})
...
var myApp = angular.module('myApp',['ui.sortable']);  /*dependency injection*/  
